export const ClientPortalPrompt = ({
  ...
  return (
    <div className="mb-8 w-full max-w-lg rounded-2xl border p-4" style={{ borderColor: `${settings.primaryColor || settings.headingColor || '#000000'}22`, backgroundColor: `${settings.primaryColor || settings.headingColor || '#000000'}0A` }}>
      <div className="flex items-start gap-3">
        <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-xl" style={{ backgroundColor: settings.primaryColor || settings.headingColor || '#000000', color: settings.buttonTextColor || '#000000' }}>
